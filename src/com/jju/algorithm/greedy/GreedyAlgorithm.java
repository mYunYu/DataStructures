package com.jju.algorithm.greedy;
...
public class GreedyAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        //定义一个临时集合，在遍历过程中存放遍历过程中的电台覆盖的地区和当前还没有覆盖的地区的交集
        ...
        while (allAreas.size() != 0){       //如果allAreas不为0，则表示还没有覆盖到所有的地区
            ...
            for (String key : broadcasts.keySet()) {
                ...
                //如果当前这个集合包含的未覆盖地区的数量，比maxKey指向的集合比未覆盖的地区还多，就需要重置maxKey
                // maxKey == null || tempSet.size() > broadcasts.get(maxKey).size())  体现出贪心算法的特点，每次都选择最优的
                if (tempSet.size() > 0
