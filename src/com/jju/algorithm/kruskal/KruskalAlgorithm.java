package com.jju.algorithm.kruskal;

import java.util.Arrays;

//Kruskal(克鲁斯卡尔)算法---解决公交问题
...
//        System.out.println("排序后=" + Arrays.toString(edges));
    ...
    public void kruskal(){
        ...
        //遍历edges 数组，将边移动到最小生成树中时，判断准备加入的边是否形成了回路，如果没有，就加入rets，否则不能加入
     ...
     * @param ends  该数组记录各个顶点对应的终点是哪个，ends 数组是在遍历过程中逐步形成的
