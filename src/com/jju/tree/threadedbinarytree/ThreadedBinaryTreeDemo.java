package com.jju.tree.threadedbinarytree;
...
//        System.out.println(node5.getNo() + "号结点的前驱结点是=" + leftNode);        //3
//
//        HeroNode rightNode = node5.getRight();
//        System.out.println(node5.getNo() + "号结点的后继结点是=" + rightNode);       //1


        //当线索化二叉树后，不能再使用原来的遍历方法
        System.out.println("使用线索化的方式遍历中序线索化二叉树======");
        threadedBinaryTree.preThreadedList();      //输出的顺序是否与中序遍历的顺序一致8, 3, 10, 1, 14, 6
...
class HeroNode {
    ...
    //说明：
    //1、如果leftType == 0 表示指向的是左子树，如果leftType == 1 表示指向前驱结点
    //2、如果rightType == 0 表示指向的是右子树，如果rightType == 1 表示指向后继结点
